...
class AppListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final hasUpdate = _app.installedVersion != null && skIsOutdated(_app);
    ...
    final canUpdate = installed != null && skIsOutdated(_app) && !trackOnly;
    final cs = Theme.of(context).colorScheme;
...
class _VersionLabel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final hasUpdate = app.installedVersion != null && skIsOutdated(app);
